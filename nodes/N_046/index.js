        ...
        return [
            {
                ...
                onChoose: function (answer, convo, bot, msg) { return __awaiter(_this, void 0, void 0, function () {
                    var threshould, calculatedZakat, paperZakat;
                    return __generator(this, function (_a) {
                        threshould = convo.vars.NODE_045 === "NODE_045.choice0"
                            ? convo.vars.gold_prices.gThreshold
                            : convo.vars.gold_prices.sThreshold;
                        calculatedZakat = N_040_1_1.getZakatForThisYear(convo.vars);
            ...
            {
                title: vars.NODE_045 === "NODE_045.choice0"
                    ? helpers_1.translate(NODE_ID + ".opt3")
                    : helpers_1.translate(NODE_ID + ".opt2"),
                payload: NODE_ID + ".choice1",
                onChoose: function (answer, convo, bot, msg) { return __awaiter(_this, void 0, void 0, function () {
                    var threshould, thresholdMetal, calculatedZakat, paperZakat;
                    return __generator(this, function (_a) {
                        threshould = convo.vars.NODE_045 === "NODE_045.choice0"
                            ? convo.vars.gold_prices.gThreshold
                            : convo.vars.gold_prices.sThreshold;
                        thresholdMetal = convo.vars.NODE_045 === "NODE_045.choice0" ? "GOLD" : "SILVER";
                        calculatedZakat = N_040_1_1.getZakatForThisYear(convo.vars);
                        paperZakat = calculatedZakat.money +
                            calculatedZakat.savings +
                            calculatedZakat.stocks;
