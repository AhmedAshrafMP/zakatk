...
import { convertVarToCurrency, convertVarToCurrencySym } from '../../helpers/i18n/index';
		...
		async (answer, convo, bot, message) => {
			...
			if (inputValue >= 0) {
				if (NODE_411 - inputValue > convo.vars.gold_prices.gThreshold) {
					...
					console.log(convo.vars.gold_prices.gThreshold, 'hello from threshgold Node-412');
