...
function getGoldPrices(currency) {
    return __awaiter(this, void 0, void 0, function () {
        var instance, resp, goldGramPrice, silverGramPrice, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, instance.get("https://data-asg.goldprice.org/dbXRates/" + currency)];
                case 1:
                    resp = _a.sent();
                    goldGramPrice = resp.data.items[0].xauPrice / 31.1;
                    silverGramPrice = resp.data.items[0].xagPrice / 31.1;
                    return [2 /*return*/, {
                            gold: goldGramPrice,
