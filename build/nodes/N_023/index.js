...
function NODE_023(convo) {
    ...
    ask_qr_1["default"](convo, NODE_ID + ".title", function (tmp, vars) {
        ...
        if (doneOptions.indexOf(NODE_ID + ".choice3") < 0) {
            quickReplies.push({
                title: helpers_1.translate(NODE_ID + ".opt4"),
        ...
        if (doneOptions.indexOf(NODE_ID + ".choice4") < 0) {
            quickReplies.push({
                title: helpers_1.translate(NODE_ID + ".opt5"),
...
exports.markOptionAsDone = markOptionAsDone;
