...
var NODE_ID = "NODE_018";
function NODE_018(convo) {
    var _this = this;
    ask_str_1["default"](convo, NODE_ID + ".hello", function (answer, convo, bot, message) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (moment_1["default"](answer).isValid()) {
                convo.setVar("LAST_ZAKAT_DAY", moment_1["default"](answer).add(1, "days").toISOString());
